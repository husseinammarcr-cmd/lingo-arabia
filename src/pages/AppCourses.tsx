              ...
              {ACTION_CARDS.map((card, i) => {
                ...
                return (
                  <motion.button
                    ...
                    className="group relative h-[160px] sm:h-[200px] rounded-3xl p-4 sm:p-5 flex flex-col text-right overflow-hidden border border-white/25 shadow-[0_12px_40px_rgba(0,0,0,0.45)] backdrop-blur-2xl hover:border-white/40 transition-colors"
                    style={{ background: card.style.gradient, color: card.style.textColor }}
                  >
                    {/* Glass sheen overlay */}
                    <span
                      aria-hidden
                      ...
                      style={{
                        background:
                          'linear-gradient(135deg, rgba(255,255,255,0.35) 0%, rgba(255,255,255,0.08) 35%, transparent 65%)',
                      }}
                    />
